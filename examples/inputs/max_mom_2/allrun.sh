...
python -u $path_to_scripts/eval_rom_acc.py --inpfile eval_rom_acc_temp_high.json

echo -e "\nRunning 'eval_rom_acc' script (low temperatures) ..."
python -u $path_to_scripts/eval_rom_acc.py --inpfile eval_rom_acc_temp_low.json
