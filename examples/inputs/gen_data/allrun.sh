...
echo -e "\nRunning 'gen_data_test' script ..."
python -u $path_to_scripts/gen_data_test.py --inpfile gen_data_test_rho.json

echo -e "\nRunning 'gen_data_test' script ..."
python -u $path_to_scripts/gen_data_test.py --inpfile gen_data_test_Thigh.json

echo -e "\nRunning 'gen_data_test' script ..."
python -u $path_to_scripts/gen_data_test.py --inpfile gen_data_test_Tlow.json
